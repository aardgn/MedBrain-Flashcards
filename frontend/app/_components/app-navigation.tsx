...
const navigationItems = [
  ...
  { id: 'study' as const, label: 'Study', href: '/cards', Icon: StudyIcon },
  { id: 'stats' as const, label: 'Stats', href: '/stats', Icon: StatsIcon },
  { id: 'tutor' as const, label: 'Tutor', href: '/', Icon: TutorIcon },
]
